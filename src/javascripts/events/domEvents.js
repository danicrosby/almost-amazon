...
import { createBook, deleteBook, getSingleBook, updateBook } from '../helpers/data/bookData';
...
const domEvents = (uid) => {
  document.querySelector('body').addEventListener('click', (e) => {
    ...
    // CLICK EVENT FOR SHOWING MODAL FORM FOR ADDING A BOOK//Check this code!!!!
    ...
    if (e.target.id.includes('update-book')) {
      ...
      // Udate book using bootstrap modal
      updateBook(firebaseKey, bookObject).then((booksArray) => {
